                ...
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="PrimaryEmailId" SortExpression="PrimaryEmailId">
                            <ItemTemplate>
                                <asp:Label ID="primaryEmailId" runat="server" Text='<%# Bind("PrimaryEmailId") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PrimaryPhoneNo" SortExpression="PrimaryPhoneNo">
                            <ItemTemplate>
                                <asp:Label ID="primaryPhoneNo" runat="server" Text='<%# Bind("PrimaryPhoneNo") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="ProfilePhoto" SortExpression="ProfilePhoto">
                            <EditItemTemplate>
                                <asp:TextBox ID="profilePhoto" runat="server" Text='<%# Bind("ProfilePhoto") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:HyperLink ID="profilePhotoLink" Target="_blank" runat="server" Text='<%# Eval("ProfilePhoto") %>' NavigateUrl='<%# $"~/DocumentHandler.ashx?guidDocumentName={Eval("GuidProfilePhoto")}" %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
